...
import { setContext, setTabContext } from "../../helpers/Context";
        ...
        <Grid container spacing={8} className="searchInterface" id="generic-store-plp">
          <div className={this.state.openFacets ? "search-facets__container show-facets" : "search-facets__container"}>
            ...
            <Grid item className="search__facet-column">
              ...
              <CategoryFacet currentPath={this.state.currentPath} productForCategory={this.state.currentProductForCategory} id="category-facet--ec_category" engine={headlessEngine_PLP} facetId="ec_category" label="Category" field="ec_category" />

              <FacetColor id="facet-color" engine={headlessEngine_PLP} facetId="f_color" label="Color" field="cat_color" />
              <FacetSize id="facet-size" engine={headlessEngine_PLP} facetId="f_size" label="Size" field="cat_size" />
